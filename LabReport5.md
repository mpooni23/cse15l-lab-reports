...
One of the cool things I learned in this course was how to use git. I learned how to add files, check-in and check-out files from the resposiotry. I also learned how to use the git desktop, The second thing I learned was how to use the find and grep commands. They have a number of command line options which are really powerful. The most important thing I learned was about how to use the vim editor from the command line. Vim is a very interesting editor with lot of features. The final thing I learned was how to create and run shell scripts. Of course, the whole process of add commands to a webserver is also something I really learned. Also, I found it very cool learning how to run a server and it gave me insights into how programmers in the real world are able to work remotely.
